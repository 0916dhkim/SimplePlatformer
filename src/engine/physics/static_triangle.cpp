...
StaticTriangle::StaticTriangle(Actor &actor, const b2Vec2 &pivot, float sideLength)
...
void StaticTriangle::UpdateShape() { UpdateShapeImpl(); }

void StaticTriangle::UpdateShapeImpl() {
